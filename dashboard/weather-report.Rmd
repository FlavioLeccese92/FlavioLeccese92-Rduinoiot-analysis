...
.plot_boxplot(properties_data, "humidity", "ls_group_boxplot", height = "400%")
```
...
.plot_boxplot(properties_data, "pressure", "ls_group_boxplot", height = "400%")
```
...
.plot_boxplot(properties_data, "temperature", "ls_group_boxplot", height = "400%")
```
...
.plot_boxplot(properties_data, "light", "ls_group_boxplot", height = "400%")
```
