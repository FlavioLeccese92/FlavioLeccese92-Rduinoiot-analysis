...
*Next development*: Embed a `flexdashboard` document inside a `workflowr` analysis.
...
First of all I decided to place the file under the subdirectory *.github/workflows*
in case I needed to trigger more actions in the future.
...
*rduinoiot-jobs-environment* on **Github**. This is very important
